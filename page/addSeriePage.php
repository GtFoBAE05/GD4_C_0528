...
include '../process/addSerieProcess.php'
?>
...
if (isset($_POST["tambah"])) {
    ...
    if ($result > 0) {
        echo
            '<script>
                alert("Berhasil tambah data"); window.location = "../page/listSeriesPage.php"
            </script>';
    } else {
        echo
            '<script>
                alert("Gagal tambah data"); window.location = "../page/listSeriesPage.php"
            </script>';
    }
}
?>
